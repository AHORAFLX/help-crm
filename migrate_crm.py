...
migrate_crm.py
==============
Wrapper específico para descargar todo el producto CRM reutilizando migrate.py.

Ventajas:
- fija el filtro `--product CRM`
- conserva el puente a author_articles.py que ya vive dentro de migrate.py
- evita duplicar la lógica principal de generación

Uso:
    python migrate_crm.py
    python migrate_crm.py --output-dir . --clean-output
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Descarga todo el producto CRM reutilizando migrate.py."
    )
    parser.add_argument(
        "--connection-string",
        default="",
    ...
    print("=====================================================")
    print(" Lanzando migrate.py específico para el producto CRM ")
    print("=====================================================")
